...
# -*- coding: utf-8 -*-
#
# GenericF2PY documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'genericf2py','_version.py')
...
htmlhelp_basename = 'GenericF2PYdoc'
...
latex_documents = [
  (master_doc, 'GenericF2PY.tex', u'GenericF2PY Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'GenericF2PY Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'GenericF2PY', u'GenericF2PY Documentation',
   author, 'GenericF2PY', 'One line description of project.',
   'Miscellaneous'),
]
